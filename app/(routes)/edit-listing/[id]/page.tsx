        ...
        <div className="flex-1 w-full max-w-7xl mx-auto px-4 md:px-8 pb-12">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2 space-y-6">
              <Skeleton className="w-full rounded-2xl h-150 bg-white border border-gray-100" />
              <Skeleton className="w-full rounded-2xl h-75 bg-white border border-gray-100" />
            </div>
            <div className="lg:col-span-1 space-y-6">
              <Skeleton className="w-full rounded-2xl h-100 bg-white border border-gray-100" />
              <Skeleton className="w-full rounded-2xl h-125 bg-white border border-gray-100" />
            </div>
          </div>
        </div>
      </div>
