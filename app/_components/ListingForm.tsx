...
import { 
  Loader2, ImagePlus, X, MapPin, 
  Home, BedDouble, Bath, Maximize,
  Tag
} from "lucide-react";
...
const FACILITIES_LIST = [
  "Air conditions", "BBQ Area",
  "Wi-Fi", "Swimming Pool",
  "Gym", "Garden",
  "Parking", "Family Rooms",
  "Spa", "Sauna",
  "Lobby", "Playground",
  "Laundry"
];
      ...
      <div className="lg:col-span-2 space-y-5">
        ...
        <div className="bg-white p-5 md:p-6 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow duration-300">
          <h3 className="text-xl font-bold text-gray-900 mb-6 flex items-center gap-2">
            <Home className="w-5 h-5 text-blue-600" /> About Properties
          </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="type" className="text-gray-600">Category</Label>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            <div className="space-y-2 relative">
              <Label htmlFor="price" className="text-gray-600">Base pricing</Label>
            ...
            <div className="space-y-2">
              <Label htmlFor="area" className="text-gray-600">Floor Area</Label>
              <div className="relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            <div className="space-y-2">
              <Label htmlFor="beds" className="text-gray-600">Total bedrooms</Label>
              <div className="relative">
            ...
            <div className="space-y-2">
              <Label htmlFor="baths" className="text-gray-600">Total bathrooms</Label>
              <div className="relative">
          ...
          <div className="space-y-2">
            <Label htmlFor="description" className="text-gray-600">Descriptions property</Label>
            <textarea
              id="description"
              name="description"
              rows={4}
        ...
        <div className="bg-white p-5 md:p-6 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow duration-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            <div className="space-y-2">
              <Label htmlFor="location" className="text-gray-600">City/Province</Label>
              <Input
                id="location"
                name="location"
                className="rounded-xl border-gray-200 focus-visible:ring-blue-500"
            ...
            <div className="space-y-2">
              <Label htmlFor="address" className="text-gray-600">Full Address</Label>
              <Input
                id="address"
                name="address"
                className="rounded-xl border-gray-200 focus-visible:ring-blue-500"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              <Label htmlFor="tag" className="text-gray-600">Tag / Badge</Label>
              <div className="relative">
      ...
      <div className="lg:col-span-1 space-y-6">
        ...
        <div className="bg-white p-5 md:p-6 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow duration-300">
          ...
          <div className="flex gap-3">
            {imagePreview && (
              <div className="w-16 h-16 rounded-xl border border-blue-500 shrink-0 bg-cover bg-center ring-2 ring-blue-100" style={{ backgroundImage: `url(${imagePreview})` }}></div>
            )}
            <div 
        ...
        <div className="bg-white p-5 md:p-6 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow duration-300">
          ...
          <p className="text-sm text-gray-500 mb-4">Select amenities included</p>
          ...
          <Button type="button" variant="outline" className="w-full mt-8 rounded-xl border-gray-200 text-gray-600 bg-gray-50 hover:bg-gray-100 hover:border-gray-300 py-6 font-semibold transition-all cursor-pointer">
            + Add custom category
          </Button>
        </div>
